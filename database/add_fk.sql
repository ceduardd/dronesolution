...
ALTER TABLE organizations
  ADD CONSTRAINT fk_organizations FOREIGN KEY(user_dni) REFERENCES users(dni);

ALTER TABLE events
  ADD CONSTRAINT fk_events FOREIGN KEY(user_dni) REFERENCES users(dni);

ALTER TABLE places
  ADD CONSTRAINT fk_places FOREIGN KEY(event_id) REFERENCES events(id) ON DELETE CASCADE;

ALTER TABLE unsubscribed_events
  ADD CONSTRAINT fk_unsubscribed_events FOREIGN KEY(event_id) REFERENCES events(id) ON DELETE CASCADE;
